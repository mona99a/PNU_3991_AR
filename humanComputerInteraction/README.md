...
-[1115157_01 نظریه زبان ها و ماشین](https://github.com/mona99a/PNU_3991_AR/tree/main/Theory-of-Languages-and-Machines) 
...
2. **فعالیت های گروهی**
    ...
    3. تحلیل نیازها
          ...
          - ارائه نیازها همه گروه با هم
              ...
              +کاربر میتواند با کلیک بر روی ایتم سبد خرید کالای انتخابی خود راکه قبلا خیره کرده مشاهده کند
              +با رفتن روی منو، منو به صورت کشویی باز خواهد شد
              +دسته بندی محصولات در منو قابل مشاهده میباشد
              +کاربر میتواند با کلیک بر روی آیتم های موجود در منو به صفحه ی مربوط به آیتم ها مراجعه کند
              +در پایین تر از صفحه کاربر با هرکت موس بر روی کالاهای به نمایش درامده میتواند کالاها رااز زاویه دیگر مشاهده کند
              +در ادامه ی صفحه یک سری پیشنهادات محصول یا تخفیف به کاربر داده میشود
              +در انتهای صفحه کاربر با کلیک بر روی ایکون برند ها میتواند تمام محصولات آن برند را مشاهده کند
              ...
              +همپنین در فوتر اظلاعاتی در مورد نحوه تحویل کالا، برگرداندن کالا در صورت نارضایتی حریم خصوصی و قوانین سایت موجوداست
      4. تجربه کاربری
            <br>
      ...
      6. [وایرفریم(صفحه ی اصلی سایت)](https://github.com/mona99a/PNU_3991_AR/tree/main/wireframe)
      7. ارائه    
